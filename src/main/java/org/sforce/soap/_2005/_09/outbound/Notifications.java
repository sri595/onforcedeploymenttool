 ...
 *         &lt;element name="Notification" type="{http://soap.sforce.com/2005/09/outbound}OFSClient__MetadataLogInformation__cNotification" maxOccurs="100"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Notifications {
    ...
    protected List<OFSClientMetadataLogInformationCNotification> notification;
     ...
     * {@link ASAClientMetadataLogInformationCNotification }
     * 
     * 
     */
    public List<OFSClientMetadataLogInformationCNotification> getNotification() {
        if (notification == null) {
            notification = new ArrayList<OFSClientMetadataLogInformationCNotification>();
        }
