package com.bitbucket.util;

import com.bitbucket.ds.AppUtil;
...
public class Constants {
	...
	public static final String NoRecords = "There are No Records Found";
	
	public static final String USERID = "srikanth@infrascape.com.lmdev";
	public static final String PASSWORD = "infrascape6waN7WfKUdAbcEzVLf2M6h5UcX";
	public static final String Server_URL = "https://na35.salesforce.com";
	...
	public static final String API_VERSION = "34.0";
	// SharingSet
	/*
	 * public static final String[] SFTypes = { "ApexClass", "ApexComponent",
	 * "ApexPage", "ApexTrigger", "AppMenu", "AssignmentRule",
	 * "AssignmentRules", "AutoResponseRules", "Community", "CustomApplication",
	 * "CustomField", "CustomLabel", "CustomLabels", "CustomObject",
	 * "CustomObjectTranslation", "CustomTab", "Dashboard", "Document",
	 * "EmailTemplate", "EscalationRule", "EscalationRules", "HomePageLayout",
	 * "Layout", "ListView", "MatchingRules", "Profile", "PermissionSet",
	 ...
	 * "ActionLinkGroupTemplate", "CompactLayout", "ConnectedApp",
	 * "CustomApplicationComponent", "CustomMetadata", "CustomPermission",
	 * "CustomSite", "FieldSet", "RecordType", "ValidationRule", "AuthProvider",
	 * "WorkflowFieldUpdate", "WorkflowRule", "WorkflowTask",
	 * "WorkflowOutboundMessage", "WorkflowAlert", "Flow", "Group",
	 * "SharingCriteriaRule", "FlowDefinition" };
	 */
	...
	/*public static final String[] SFTypes = { "ApexClass", "ApexComponent",
			...
			"EscalationRule", "EscalationRules", "HomePageLayout", "Layout",
			"ListView", "MatchingRules", "MatchingRules", "Profile",
			"PermissionSet", "QuickAction", "RemoteSiteSetting", "ReportType",
			"Settings", "SharingRules", "StaticResource", "WebLink",
			"CustomPageWebLink", "Queue", "ApprovalProcess",
			"ActionLinkGroupTemplate", "CompactLayout", "ConnectedApp",
			"CustomApplicationComponent", "CustomMetadata", "CustomPermission",
			"CustomSite", "FieldSet", "RecordType", "ValidationRule",
			"AuthProvider", "WorkflowFieldUpdate", "WorkflowRule",
			"WorkflowTask", "WorkflowOutboundMessage", "WorkflowAlert", "Flow",
			"Group", "SharingCriteriaRule", "FlowDefinition",
			"LiveChatAgentConfig", "LiveChatButton","LiveChatDeployment"};*/
	
	public static final String[] SFTypes = { "ApexClass", "ApexComponent",
		"ApexPage", "ApexTrigger", "AppMenu","CustomObject"};

	// public static final String[] SFTypes = { "Workflow"};
	...
	public static final String VALIDATE_SUCESS_MESSAGE = "Validate request sucessfully processed";
	...
	public static final String MetadataDescription_Name = "OFSServer__MetadataDescription__c";
	public static final String MetadataDescriptionInformation_Name = "OFSClient__MetadataDescriptionInformation__c";
	public static int ChunkSize = 8000;
	public static int waitFor2Sec = 2000;
	public static int waitFor1Sec = 1000;
	public static String BaseOrgClientID = "3MVG9fMtCkV6eLhckipcGtsdEsbYJXSOdJrdCVqxaLEyjnLDaPGLekViuBqlQJcWVyZodXI42r34WH9F5wexo";
	public static String BaseOrgClientSecret = "1673914982220759042";
	public static String CustomOrgClientID = "3MVG9fMtCkV6eLhckipcGtsdEsXpvuj0tgLP6bJJYaFcdwyUC5dmSJ.Oi2e6vkHAZMrNBY6k8y9Qf.QWFahCK";
	...
	public static String DEPLOY_REQ = "DEPLOYREQ";
	public static String RETRIEVE_REQ = "RETRIEVEREQ";
	public static final String RELEASE_STATUS_ACTIVE = "Active";
	public static final String RELEASE_STATUS_INACTIVE = "InActive";
	public static final String RELEASE_COMPLETED_STATUS = "Completed";
	public static final String ACTION_GETPACKAGES = "GetPackages";
