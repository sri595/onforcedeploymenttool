...
public class MetadataLogDO {
	...
	private String ValidationSuccessId;
	 ...
	 */
	public MetadataLogDO(String id, String baseOrgId, String baseOrgToken,
			...
			String ValidationSuccessId, String testLevel) {
		this.id = id;
		...
		this.ValidationSuccessId = ValidationSuccessId;
	 ...
	 * 
	 * @param Setting
	 *            Number Of Packages By Order To HashMap
	 */
	...
	public String getValidationSuccessId() {
		return ValidationSuccessId;
	}

	public void setValidationSuccessId(String validationSuccessId) {
