 ...
 *         &lt;element name="Notification" type="{http://soap.sforce.com/2005/09/outbound}MetadataLog__cNotification" maxOccurs="100"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Notifications {
    ...
    protected List<OFSServerMetadataLogCNotification> notification;
     ...
     * {@link OFSServerMetadataLogCNotification }
     * 
     * 
     */
    public List<OFSServerMetadataLogCNotification> getNotification() {
        if (notification == null) {
            notification = new ArrayList<OFSServerMetadataLogCNotification>();
        }
