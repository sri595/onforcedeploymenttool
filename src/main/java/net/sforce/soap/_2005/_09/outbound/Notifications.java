...
public class Notifications {
    ...
    protected List<MetadataLogCNotification> notification;
     ...
     * {@link MetadataLogCNotification }
     * 
     * 
     */
    public List<MetadataLogCNotification> getNotification() {
        if (notification == null) {
            notification = new ArrayList<MetadataLogCNotification>();
        }
